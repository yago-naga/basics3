...
public class N4ReaderTest {
  ...
  public void test00() throws IOException {
    ...
    String exectedOutputFilePath = RESOURCESPATH + "/output/test-" + testFileNumber + ".out";
    
    runAndCompare(testFilePath, exectedOutputFilePath);
  }
  ...
  private void runAndCompare(String testFilePath, String exectedOutputFilePath) throws IOException {
    ...
    nr = new N4Reader(new File(exectedOutputFilePath));
    while(nr.hasNext())
